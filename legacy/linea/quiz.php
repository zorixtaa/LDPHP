...
<body>
    ...
    <header class="header">
        ...
        <div style ="text-align:center;margin-left: auto;margin-right: auto;"><span class="page-title">Quiz</span></div>
    </header>
    ...
    <main class="main-content">
        ...
        <!--div class="row"-->
            <div class="table-container row">
                <h2 class="dashboard-title" > Last Added Quiz </h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
            ...
            <div class="table-container row"><h2 class="dashboard-title" > Quiz of the day </h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
