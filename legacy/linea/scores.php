...
<body>
    ...
    <header class="header">
        ...
        <div style ="text-align:center;margin-left: auto;margin-right: auto;"><span class="page-title">Scores</span></div>
    </header>
    ...
    <main class="main-content">
        ...
        <!--div class="row"-->
            <div class="table-container row">
                <h2 class="dashboard-title" > Last Scores Quiz </h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
            ...
            <div class="table-container row"><h2 class="dashboard-title" > Scores Quiz of the day </h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
